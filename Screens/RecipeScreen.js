    ...
    <ScrollView style={styles.container}>
      ...
      >
        <View style={styles.iconText}>
          ...
          <Text style={styles.texticon}>
            {DUMMY_RECIPE.readyInMinutes} minutes
          </Text>
        </View>
        <View style={styles.iconText}>
          <Icon name="fastfood" />
          <Text style={styles.texticon}>{DUMMY_RECIPE.servings} servings</Text>
        </View>
      </View>
      <View
        style={{
      ...
      >
        ...
        <View style={{ alignItems: "center", justifyContent: "center" }}>
          ...
          >
            {Math.round(DUMMY_RECIPE.pricePerServing)}
          </Text>
        ...
        <View style={{ alignItems: "center", justifyContent: "center" }}>
          ...
          >
            {Math.round(DUMMY_RECIPE.spoonacularScore)}
          </Text>
          <Text style={{ paddingLeft: 10, paddingTop: 10 }}>Spoonacular</Text>
      ...
      <View style={{ margin: 10 }}>
        ...
        <SectionList
          sections={[
            {
              data: DUMMY_RECIPE.extendedIngredients.map((item) => {
      ...
      {!DUMMY_RECIPE.instructions && (
        <View>
          ...
          <Text style={{ margin: 10, textAlign: "center" }}>
            No Instruction found! Try again later.
          </Text>
        </View>
      )}
      {DUMMY_RECIPE.instructions && (
      ...
      >
        <Button onPress={handleLoadSimilar} > Load similar recipes? </Button>
      </View>
    </ScrollView>
  );
};
